"""
Django settings for tw_clients project.
...
SECRET_KEY = 'vq@0-_6zph#-z4k_nlk9vhuiz3))rmp9ja0pkbxq3xj3fr#1m3'
...
WSGI_APPLICATION = 'tw_clients.wsgi.application'
